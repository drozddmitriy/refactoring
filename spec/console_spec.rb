RSpec.describe Console do
  ...
  describe '#create_card' do
    ...
    context 'when incorrect card choose' do
      it do
        ...
        allow(current_subject.database).to receive(:load).and_return([])
  ...
  describe '#create_the_first_account' do
    ...
    it 'with correct outout' do
      ...
      expect { current_subject.create_the_first_account }.to output(COMMON_PHRASE[:create_first_account]).to_stdout
    end
  ...
  describe '#load' do
    ...
    context 'with active accounts' do
      ...
      before do
        ...
        allow(current_subject.database).to receive(:load) {
    ...
    context 'with cards' do
      ...
      context 'with correct outout' do
        it do
          ...
          expect { current_subject.destroy_card }.to output(/#{COMMON_PHRASE[:if_you_want_to_delete]}/).to_stdout
      ...
      context 'with correct input of card number' do
        ...
        before do
          current_subject.instance_variable_set(:@file_path, OVERRIDABLE_FILENAME)
          allow(current_subject.database).to receive(:load) { [current_subject] }
          account_subject.instance_variable_set(:@cards, fake_cards)
          current_subject.instance_variable_set(:@account, account_subject)
          current_subject.account.instance_variable_set(:@current_account, account_subject)
        end
    ...
    context 'with cards' do
      ...
      context 'with correct outout' do
        it do
          ...
          current_subject.instance_variable_set(:@account, account_subject)
          allow(current_subject).to receive_message_chain(:gets, :chomp) { 'exit' }
          expect { current_subject.put_money }.to output(/#{COMMON_PHRASE[:choose_card]}/).to_stdout
          fake_cards.each_with_index do |card, i|
            message = /- #{card.number}, #{card.type}, press #{i + 1}/
      ...
      context 'with correct input of card number' do
        ...
        context 'with correct output' do
          ...
          it do
            expect { current_subject.put_money }.to output(/#{COMMON_PHRASE[:input_amount]}/).to_stdout
          end
        end
    ...
    context 'with cards' do
      ...
      context 'with correct outout' do
        it do
          ...
          current_subject.instance_variable_set(:@account, account_subject)
          allow(current_subject).to receive_message_chain(:gets, :chomp) { 'exit' }
          expect { current_subject.withdraw_money }.to output(/#{COMMON_PHRASE[:choose_card_withdrawing]}/).to_stdout
          fake_cards.each_with_index do |card, i|
            message = /- #{card.number}, #{card.type}, press #{i + 1}/
      ...
      context 'with correct input of card number' do
        ...
        context 'with correct output' do
          ...
          it do
            expect { current_subject.withdraw_money }.to output(/#{COMMON_PHRASE[:withdraw_amount]}/).to_stdout
          end
        end
      end
    end
  ...
  describe '#destroy_account' do
    ...
    it 'with correct outout' do
      expect(current_subject).to receive_message_chain(:gets, :chomp) {}
      expect { current_subject.destroy_account }.to output(COMMON_PHRASE[:destroy_account]).to_stdout
    end
  end
end
